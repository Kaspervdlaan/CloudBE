...
-- Create function to update updated_at timestamp (used by multiple tables)
...
-- Create users table first (referenced by files table)
-- Create users table
...
-- Create files table (references users table)
...
-- Create trigger to automatically update updated_at for files
